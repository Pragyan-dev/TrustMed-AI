...
SAFETY_CRITIC_MAX_TOKENS = _int_env("SAFETY_CRITIC_MAX_TOKENS", SAFETY_MAX_TOKENS)
SOAP_MAX_TOKENS = _int_env("SOAP_MAX_TOKENS", 1200)
DIRECT_MAX_TOKENS = _int_env("DIRECT_MAX_TOKENS", 500)
SYNTHESIS_MAX_TOKENS = _int_env("SYNTHESIS_MAX_TOKENS", 32768)
...
SAFETY_CRITIC_TIMEOUT_SECONDS = _int_env("SAFETY_CRITIC_TIMEOUT_SECONDS", 12)
SAFETY_CRITIC_MAX_RETRIES = _int_env("SAFETY_CRITIC_MAX_RETRIES", 1)
SYNTHESIS_TIMEOUT_SECONDS = _int_env("SYNTHESIS_TIMEOUT_SECONDS", 40)
SYNTHESIS_REQUEST_TIMEOUT_SECONDS = _int_env("SYNTHESIS_REQUEST_TIMEOUT_SECONDS", 300)
SYNTHESIS_FIRST_TOKEN_TIMEOUT_SECONDS = _int_env("SYNTHESIS_FIRST_TOKEN_TIMEOUT_SECONDS", 60)
SYNTHESIS_IDLE_TOKEN_TIMEOUT_SECONDS = _int_env("SYNTHESIS_IDLE_TOKEN_TIMEOUT_SECONDS", 60)
SYNTHESIS_DIRECT_FALLBACK_TIMEOUT_SECONDS = _int_env("SYNTHESIS_DIRECT_FALLBACK_TIMEOUT_SECONDS", 120)
